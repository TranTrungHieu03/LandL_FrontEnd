...
const ProductInformation = () => {
  ...
  return <div className={'flex flex-col mt-6 px-4'}>
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className={'w-full flex flex-col gap-y-3'}>
        <div className={'grid grid-cols-2  gap-x-2 gap-y-4'}>
          <FormInput name={'productName'} form={form} placeholder={'Ex: Item name'}
                     classContent={'col-span-1'}
                     autoFocus />
          <FormInput name={'productDescription'} form={form} placeholder={'Ex: Item description'}
                     classContent={'col-span-1'}
          />
